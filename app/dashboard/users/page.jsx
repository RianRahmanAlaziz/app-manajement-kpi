            ...
            <div className="grid grid-cols-12 gap-6 mt-5">
                <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <button
                        ...
                        className="btn btn-primary shadow-md mr-2">Add New Product
                    </button>
                    {showModal && (
                        <Modal
                        ...
                        >
                            <p className="text-sm text-gray-600">Ini isi modalnya. Bisa apa saja di sini.</p>
                        </Modal>
                    )}
                    ...
                    <table className="table table-report -mt-2">
                        ...
                        <tbody>
                            <tr className="intro-x">
                                ...
                                <td className="w-40">
                                    <div className="flex items-center justify-center text-danger"> <i
                                        data-lucide="check-square" className="w-4 h-4 mr-2"></i> Inactive </div>
                                </td>
